## Gradient Descent Example for Linear Regression Machine Learning
...
Using these parameters, A gradient descent search is successfully executed on a sample data set of 100 points. Here is a visualization of the search running for 200 iterations using an initial guess of `m = 0`, `b = 0`, and with a learning rate of `0.000005`.

<img src="https://github.com/mattnedrich/GradientDescentExample/blob/master/gradient_descent_example.gif" width="580">

### Execution
To run the given example, simply run the `gradient_descent_example.py` file using Python itself.

```
python gradient_descent_example.py
```

The output will look like this as follows :
